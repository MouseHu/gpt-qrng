...
class Trainer:
    ...
    def set_callback(self, onevent: str, callback):
        if len(self.callbacks[onevent]) == 0:
    ...
    def run(self):
        ...
        self.base_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(self.optimizer, T_max=self.config.max_epochs,
